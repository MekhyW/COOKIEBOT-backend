...
class ConfigsControllerTest {
    ...
    @Test
    public void getGroupConfig_userIsAdmin() throws Exception {
    ...
    @Test
    public void getGroupConfig_userNotAdmin() throws Exception {
        final var config = new Config();
        config.setId("group1");
        config.setSfw(true);
        config.setLanguage("pt-BR");
    ...
    @Test
    public void updateGroupConfig_userIsAdmin() throws Exception {
        final var config = new Config();
        config.setId("group1");
        config.setSfw(true);
        config.setLanguage("pt-BR");
    ...
    @Test
    public void updateGroupConfig_userIsNotAdmin() throws Exception {
        final var config = new Config();
        config.setId("group1");
        config.setSfw(true);
        config.setLanguage("pt-BR");
